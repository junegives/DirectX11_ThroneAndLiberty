...
CToolUIInstanceDialogue::CToolUIInstanceDialogue()
{
...
HRESULT CToolUIInstanceDialogue::Initialize(vector<string>& _strTextureTags, const string& _strMaskTextureTag, const string& _strNoiseTextureTag, CToolUIBase::ToolUIDesc& _UIDesc, CVIInstancing::InstanceDesc& _InstanceDesc, vector<_float2>& _vUIPos, vector<_float2>& _vUISize)
{
...
void CToolUIInstanceDialogue::PriorityTick(_float _fTimeDelta)
{

}

void CToolUIInstanceDialogue::Tick(_float _fTimeDelta)
{
    KeyInput();
...
void CToolUIInstanceDialogue::LateTick(_float _fTimeDelta)
{
...
HRESULT CToolUIInstanceDialogue::Render()
{
...
HRESULT CToolUIInstanceDialogue::AddComponent(vector<string>& _strTextureTags, const string& _strMaskTextureTag, const string& _strNoiseTextureTag, CVIInstancing::InstanceDesc& _InstanceDesc, vector<_float2>& _vUIPos, vector<_float2>& _vUISize)
{
...
shared_ptr<CToolUIInstanceDialogue> CToolUIInstanceDialogue::Create(vector<string>& _strTextureTags, const string& _strMaskTextureTag, const string& _strNoiseTextureTag, CToolUIBase::ToolUIDesc& _UIDesc, CVIInstancing::InstanceDesc& _InstanceDesc, vector<_float2>& _vUIPos, vector<_float2>& _vUISize)
{
    shared_ptr<CToolUIInstanceDialogue> pInstance = make_shared<CToolUIInstanceDialogue>();
    ...
    {
        MessageBox(nullptr, L"Initialize Failed", L"CToolUIInstanceDialogue::Create", MB_OK);
