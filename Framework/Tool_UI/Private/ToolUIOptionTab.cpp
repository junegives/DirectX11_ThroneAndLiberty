...
CToolUIOptionTab::CToolUIOptionTab()
{
...
HRESULT CToolUIOptionTab::Initialize(vector<string>& _strTextureTags, const string& _strMaskTextureTag, const string& _strNoiseTextureTag, CToolUIBase::ToolUIDesc& _UIDesc, CVIInstancing::InstanceDesc& _InstanceDesc, vector<_float2>& _vUIPos, vector<_float2>& _vUISize)
{
...
void CToolUIOptionTab::PriorityTick(_float _fTimeDelta)
{

}

void CToolUIOptionTab::Tick(_float _fTimeDelta)
{
    KeyInput();
...
void CToolUIOptionTab::LateTick(_float _fTimeDelta)
{
...
HRESULT CToolUIOptionTab::Render()
{
...
HRESULT CToolUIOptionTab::AddComponent(vector<string>& _strTextureTags, const string& _strMaskTextureTag, const string& _strNoiseTextureTag, CVIInstancing::InstanceDesc& _InstanceDesc, vector<_float2>& _vUIPos, vector<_float2>& _vUISize)
{
...
shared_ptr<CToolUIOptionTab> CToolUIOptionTab::Create(vector<string>& _strTextureTags, const string& _strMaskTextureTag, const string& _strNoiseTextureTag, CToolUIBase::ToolUIDesc& _UIDesc, CVIInstancing::InstanceDesc& _InstanceDesc, vector<_float2>& _vUIPos, vector<_float2>& _vUISize)
{
    shared_ptr<CToolUIOptionTab> pInstance = make_shared<CToolUIOptionTab>();
    ...
    {
        MessageBox(nullptr, L"Initialize Failed", L"CToolUIOptionTab::Create", MB_OK);
