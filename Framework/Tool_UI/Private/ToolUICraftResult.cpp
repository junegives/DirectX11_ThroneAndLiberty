...
CToolUICraftResult::CToolUICraftResult()
{
...
HRESULT CToolUICraftResult::Initialize(vector<string>& _strTextureTags, const string& _strMaskTextureTag, const string& _strNoiseTextureTag, CToolUIBase::ToolUIDesc& _UIDesc, CVIInstancing::InstanceDesc& _InstanceDesc, vector<_float2>& _vUIPos, vector<_float2>& _vUISize)
{
    ...
    m_iShaderPass = 17;
    m_ToolUIDesc.iShaderPassIdx = 17;
...
void CToolUICraftResult::PriorityTick(_float _fTimeDelta)
{

}

void CToolUICraftResult::Tick(_float _fTimeDelta)
{
    KeyInput();
...
void CToolUICraftResult::LateTick(_float _fTimeDelta)
{
...
HRESULT CToolUICraftResult::Render()
{
...
HRESULT CToolUICraftResult::AddComponent(vector<string>& _strTextureTags, const string& _strMaskTextureTag, const string& _strNoiseTextureTag, CVIInstancing::InstanceDesc& _InstanceDesc, vector<_float2>& _vUIPos, vector<_float2>& _vUISize)
{
...
shared_ptr<CToolUICraftResult> CToolUICraftResult::Create(vector<string>& _strTextureTags, const string& _strMaskTextureTag, const string& _strNoiseTextureTag, CToolUIBase::ToolUIDesc& _UIDesc, CVIInstancing::InstanceDesc& _InstanceDesc, vector<_float2>& _vUIPos, vector<_float2>& _vUISize)
{
    shared_ptr<CToolUICraftResult> pInstance = make_shared<CToolUICraftResult>();
    ...
    {
        MessageBox(nullptr, L"Initialize Failed", L"CToolUICraftResult::Create", MB_OK);
