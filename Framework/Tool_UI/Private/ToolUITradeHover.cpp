...
CToolUITradeHover::CToolUITradeHover()
{
...
HRESULT CToolUITradeHover::Initialize(vector<string>& _strTextureTags, const string& _strMaskTextureTag, const string& _strNoiseTextureTag, CToolUIBase::ToolUIDesc& _UIDesc, CVIInstancing::InstanceDesc& _InstanceDesc, vector<_float2>& _vUIPos, vector<_float2>& _vUISize)
{
...
void CToolUITradeHover::PriorityTick(_float _fTimeDelta)
{

}

void CToolUITradeHover::Tick(_float _fTimeDelta)
{
    KeyInput();
...
void CToolUITradeHover::LateTick(_float _fTimeDelta)
{
...
HRESULT CToolUITradeHover::Render()
{
...
HRESULT CToolUITradeHover::AddComponent(vector<string>& _strTextureTags, const string& _strMaskTextureTag, const string& _strNoiseTextureTag, CVIInstancing::InstanceDesc& _InstanceDesc, vector<_float2>& _vUIPos, vector<_float2>& _vUISize)
{
...
shared_ptr<CToolUITradeHover> CToolUITradeHover::Create(vector<string>& _strTextureTags, const string& _strMaskTextureTag, const string& _strNoiseTextureTag, CToolUIBase::ToolUIDesc& _UIDesc, CVIInstancing::InstanceDesc& _InstanceDesc, vector<_float2>& _vUIPos, vector<_float2>& _vUISize)
{
    shared_ptr<CToolUITradeHover> pInstance = make_shared<CToolUITradeHover>();
    ...
    {
        MessageBox(nullptr, L"Initialize Failed", L"CToolUITradeHover::Create", MB_OK);
