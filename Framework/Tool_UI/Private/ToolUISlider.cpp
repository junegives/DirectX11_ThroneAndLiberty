...
HRESULT CToolUISlider::Initialize(vector<string>& _strTextureTags, const string& _strMaskTextureTag, const string& _strNoiseTextureTag, CToolUIBase::ToolUIDesc& _ToolUIDesc, CVIInstancing::InstanceDesc& _InstanceDesc)
{
...
void CToolUISlider::PriorityTick(_float _fDeltaTime)
{

}

void CToolUISlider::Tick(_float _fDeltaTime)
{
    KeyInput();
    SliderKeyInput();
...
void CToolUISlider::LateTick(_float _fDeltaTime)
{
...
void CToolUISlider::SliderKeyInput()
{
...
HRESULT CToolUISlider::AddComponent(vector<string>& _strTextureTags, const string& _strMaskTextureTag, const string& _strNoiseTextureTag, CVIInstancing::InstanceDesc& _InstanceDesc)
{
...
shared_ptr<CToolUISlider> CToolUISlider::Create(vector<string>& _strTextureTags, const string& _strMaskTextureTag, const string& _strNoiseTextureTag, CToolUIBase::ToolUIDesc& _ToolUIDesc, CVIInstancing::InstanceDesc& _InstanceDesc)
{
    shared_ptr<CToolUISlider> pInstance = make_shared<CToolUISlider>();

    if (FAILED(pInstance->Initialize(_strTextureTags, _strMaskTextureTag, _strNoiseTextureTag, _ToolUIDesc, _InstanceDesc)))
    {
        MessageBox(nullptr, L"Initialize Failed", L"CToolUISlider::Create", MB_OK);
