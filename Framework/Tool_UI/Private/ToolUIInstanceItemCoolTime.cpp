...
CToolUIInstanceItemCoolTime::CToolUIInstanceItemCoolTime()
{
...
HRESULT CToolUIInstanceItemCoolTime::Initialize(vector<string>& _strTextureTags, const string& _strMaskTextureTag, const string& _strNoiseTextureTag, CToolUIBase::ToolUIDesc& _UIDesc, CVIInstancing::InstanceDesc& _InstanceDesc, vector<_float2>& _vUIPos, vector<_float2>& _vUISize)
{
...
void CToolUIInstanceItemCoolTime::PriorityTick(_float _fTimeDelta)
{

}

void CToolUIInstanceItemCoolTime::Tick(_float _fTimeDelta)
{
    KeyInput();
...
void CToolUIInstanceItemCoolTime::LateTick(_float _fTimeDelta)
{
...
HRESULT CToolUIInstanceItemCoolTime::Render()
{
...
void CToolUIInstanceItemCoolTime::IsRender(_float _fVisibleYTop, _float _fVisibleYBottom)
{
    /* CoolTime은 아마 안쓸 예정 */
...
_int CToolUIInstanceItemCoolTime::IsInstanceMouseOn()
{
    POINT mousePt;
...
HRESULT CToolUIInstanceItemCoolTime::AddComponent(vector<string>& _strTextureTags, const string& _strMaskTextureTag, const string& _strNoiseTextureTag, CVIInstancing::InstanceDesc& _InstanceDesc, vector<_float2>& _vUIPos, vector<_float2>& _vUISize)
{
...
shared_ptr<CToolUIInstanceItemCoolTime> CToolUIInstanceItemCoolTime::Create(vector<string>& _strTextureTags, const string& _strMaskTextureTag, const string& _strNoiseTextureTag, CToolUIBase::ToolUIDesc& _UIDesc, CVIInstancing::InstanceDesc& _InstanceDesc, vector<_float2>& _vUIPos, vector<_float2>& _vUISize)
{
    shared_ptr<CToolUIInstanceItemCoolTime> pInstance = make_shared<CToolUIInstanceItemCoolTime>();
    ...
    {
        MessageBox(nullptr, L"Initialize Failed", L"CToolUIInstanceItemCoolTime::Create", MB_OK);
