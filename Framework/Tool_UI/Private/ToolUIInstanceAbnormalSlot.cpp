...
CToolUIInstanceAbnormalSlot::CToolUIInstanceAbnormalSlot()
{
...
HRESULT CToolUIInstanceAbnormalSlot::Initialize(vector<string>& _strTextureTags, const string& _strMaskTextureTag, const string& _strNoiseTextureTag, CToolUIBase::ToolUIDesc& _UIDesc, CVIInstancing::InstanceDesc& _InstanceDesc, vector<_float2>& _vUIPos, vector<_float2>& _vUISize)
{
...
void CToolUIInstanceAbnormalSlot::PriorityTick(_float _fTimeDelta)
{

}

void CToolUIInstanceAbnormalSlot::Tick(_float _fTimeDelta)
{
    KeyInput();
...
void CToolUIInstanceAbnormalSlot::LateTick(_float _fTimeDelta)
{
...
HRESULT CToolUIInstanceAbnormalSlot::Render()
{
...
HRESULT CToolUIInstanceAbnormalSlot::AddComponent(vector<string>& _strTextureTags, const string& _strMaskTextureTag, const string& _strNoiseTextureTag, CVIInstancing::InstanceDesc& _InstanceDesc, vector<_float2>& _vUIPos, vector<_float2>& _vUISize)
{
...
shared_ptr<CToolUIInstanceAbnormalSlot> CToolUIInstanceAbnormalSlot::Create(vector<string>& _strTextureTags, const string& _strMaskTextureTag, const string& _strNoiseTextureTag, CToolUIBase::ToolUIDesc& _UIDesc, CVIInstancing::InstanceDesc& _InstanceDesc, vector<_float2>& _vUIPos, vector<_float2>& _vUISize)
{
    shared_ptr<CToolUIInstanceAbnormalSlot> pInstance = make_shared<CToolUIInstanceAbnormalSlot>();
    ...
    {
        MessageBox(nullptr, L"Initialize Failed", L"CToolUIInstanceAbnormalSlot::Create", MB_OK);
