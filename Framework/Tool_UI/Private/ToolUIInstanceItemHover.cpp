...
CToolUIInstanceItemHover::CToolUIInstanceItemHover()
{
...
HRESULT CToolUIInstanceItemHover::Initialize(vector<string>& _strTextureTags, const string& _strMaskTextureTag, const string& _strNoiseTextureTag, CToolUIBase::ToolUIDesc& _UIDesc, CVIInstancing::InstanceDesc& _InstanceDesc, vector<_float2>& _vUIPos, vector<_float2>& _vUISize)
{
...
void CToolUIInstanceItemHover::PriorityTick(_float _fTimeDelta)
{

}

void CToolUIInstanceItemHover::Tick(_float _fTimeDelta)
{
    KeyInput();
...
void CToolUIInstanceItemHover::LateTick(_float _fTimeDelta)
{
...
HRESULT CToolUIInstanceItemHover::Render()
{
...
void CToolUIInstanceItemHover::IsRender(_float _fVisibleYTop, _float _fVisibleYBottom)
{
...
_int CToolUIInstanceItemHover::IsInstanceMouseOn()
{
    POINT mousePt;
...
HRESULT CToolUIInstanceItemHover::AddComponent(vector<string>& _strTextureTags, const string& _strMaskTextureTag, const string& _strNoiseTextureTag, CVIInstancing::InstanceDesc& _InstanceDesc, vector<_float2>& _vUIPos, vector<_float2>& _vUISize)
{
...
shared_ptr<CToolUIInstanceItemHover> CToolUIInstanceItemHover::Create(vector<string>& _strTextureTags, const string& _strMaskTextureTag, const string& _strNoiseTextureTag, CToolUIBase::ToolUIDesc& _UIDesc, CVIInstancing::InstanceDesc& _InstanceDesc, vector<_float2>& _vUIPos, vector<_float2>& _vUISize)
{
    shared_ptr<CToolUIInstanceItemHover> pInstance = make_shared<CToolUIInstanceItemHover>();
    ...
    {
        MessageBox(nullptr, L"Initialize Failed", L"CToolUIInstanceItemHover::Create", MB_OK);
