...
CToolUIInstanceItemIcon::CToolUIInstanceItemIcon()
{
...
HRESULT CToolUIInstanceItemIcon::Initialize(vector<string>& _strTextureTags, const string& _strMaskTextureTag, const string& _strNoiseTextureTag, CToolUIBase::ToolUIDesc& _UIDesc, CVIInstancing::InstanceDesc& _InstanceDesc, vector<_float2>& _vUIPos, vector<_float2>& _vUISize)
{
...
void CToolUIInstanceItemIcon::PriorityTick(_float _fTimeDelta)
{

}

void CToolUIInstanceItemIcon::Tick(_float _fTimeDelta)
{
    KeyInput();
...
void CToolUIInstanceItemIcon::LateTick(_float _fTimeDelta)
{
    ...
    if (!m_pUIChildren.empty())
    {
        for (auto& childPair : m_pUIChildren)
        {
            if (childPair.second.lock() != nullptr)
            {
                if (childPair.second.lock()->GetUIType() == TOOL_UI_INSTANCEITEMHOVER)
                {
...
HRESULT CToolUIInstanceItemIcon::Render()
{
...
void CToolUIInstanceItemIcon::IsRender(_float _fVisibleYTop, _float _fVisibleYBottom)
{
...
_int CToolUIInstanceItemIcon::IsInstanceMouseOn()
{
    POINT mousePt;
...
HRESULT CToolUIInstanceItemIcon::AddComponent(vector<string>& _strTextureTags, const string& _strMaskTextureTag, const string& _strNoiseTextureTag, CVIInstancing::InstanceDesc& _InstanceDesc, vector<_float2>& _vUIPos, vector<_float2>& _vUISize)
{
...
shared_ptr<CToolUIInstanceItemIcon> CToolUIInstanceItemIcon::Create(vector<string>& _strTextureTags, const string& _strMaskTextureTag, const string& _strNoiseTextureTag, CToolUIBase::ToolUIDesc& _UIDesc, CVIInstancing::InstanceDesc& _InstanceDesc, vector<_float2>& _vUIPos, vector<_float2>& _vUISize)
{
    shared_ptr<CToolUIInstanceItemIcon> pInstance = make_shared<CToolUIInstanceItemIcon>();
    ...
    {
        MessageBox(nullptr, L"Initialize Failed", L"CToolUIInstanceItemIcon::Create", MB_OK);
