...
CToolUITradeSlot::CToolUITradeSlot()
{
...
HRESULT CToolUITradeSlot::Initialize(vector<string>& _strTextureTags, const string& _strMaskTextureTag, const string& _strNoiseTextureTag, CToolUIBase::ToolUIDesc& _UIDesc, CVIInstancing::InstanceDesc& _InstanceDesc, vector<_float2>& _vUIPos, vector<_float2>& _vUISize)
{
...
void CToolUITradeSlot::PriorityTick(_float _fTimeDelta)
{

}

void CToolUITradeSlot::Tick(_float _fTimeDelta)
{
    KeyInput();
...
void CToolUITradeSlot::LateTick(_float _fTimeDelta)
{
...
HRESULT CToolUITradeSlot::Render()
{
...
HRESULT CToolUITradeSlot::AddComponent(vector<string>& _strTextureTags, const string& _strMaskTextureTag, const string& _strNoiseTextureTag, CVIInstancing::InstanceDesc& _InstanceDesc, vector<_float2>& _vUIPos, vector<_float2>& _vUISize)
{
...
shared_ptr<CToolUITradeSlot> CToolUITradeSlot::Create(vector<string>& _strTextureTags, const string& _strMaskTextureTag, const string& _strNoiseTextureTag, CToolUIBase::ToolUIDesc& _UIDesc, CVIInstancing::InstanceDesc& _InstanceDesc, vector<_float2>& _vUIPos, vector<_float2>& _vUISize)
{
    shared_ptr<CToolUITradeSlot> pInstance = make_shared<CToolUITradeSlot>();
    ...
    {
        MessageBox(nullptr, L"Initialize Failed", L"CToolUITradeSlot::Create", MB_OK);
