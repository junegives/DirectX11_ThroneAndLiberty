...
CToolUIInstanceQuestIndicator::CToolUIInstanceQuestIndicator()
{
...
HRESULT CToolUIInstanceQuestIndicator::Initialize(vector<string>& _strTextureTags, const string& _strMaskTextureTag, const string& _strNoiseTextureTag, CToolUIBase::ToolUIDesc& _UIDesc, CVIInstancing::InstanceDesc& _InstanceDesc, vector<_float2>& _vUIPos, vector<_float2>& _vUISize)
{
...
void CToolUIInstanceQuestIndicator::PriorityTick(_float _fTimeDelta)
{

}

void CToolUIInstanceQuestIndicator::Tick(_float _fTimeDelta)
{
    KeyInput();
...
void CToolUIInstanceQuestIndicator::LateTick(_float _fTimeDelta)
{
...
HRESULT CToolUIInstanceQuestIndicator::Render()
{
...
HRESULT CToolUIInstanceQuestIndicator::AddComponent(vector<string>& _strTextureTags, const string& _strMaskTextureTag, const string& _strNoiseTextureTag, CVIInstancing::InstanceDesc& _InstanceDesc, vector<_float2>& _vUIPos, vector<_float2>& _vUISize)
{
...
shared_ptr<CToolUIInstanceQuestIndicator> CToolUIInstanceQuestIndicator::Create(vector<string>& _strTextureTags, const string& _strMaskTextureTag, const string& _strNoiseTextureTag, CToolUIBase::ToolUIDesc& _UIDesc, CVIInstancing::InstanceDesc& _InstanceDesc, vector<_float2>& _vUIPos, vector<_float2>& _vUISize)
{
    shared_ptr<CToolUIInstanceQuestIndicator> pInstance = make_shared<CToolUIInstanceQuestIndicator>();
    ...
    {
        MessageBox(nullptr, L"Initialize Failed", L"CToolUIInstanceQuestIndicator::Create", MB_OK);
