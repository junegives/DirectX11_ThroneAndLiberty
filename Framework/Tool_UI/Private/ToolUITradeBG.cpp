...
HRESULT CToolUITradeBG::Initialize(vector<string>& _strTextureTags, const string& _strMaskTextureTag, const string& _strNoiseTextureTag, CToolUIBase::ToolUIDesc& _UIDesc, CVIInstancing::InstanceDesc& _InstanceDesc, vector<_float2>& _vUIPos, vector<_float2>& _vUISize)
{
...
void CToolUITradeBG::PriorityTick(_float _fTimeDelta)
{

}

void CToolUITradeBG::Tick(_float _fTimeDelta)
{
    KeyInput();
...
void CToolUITradeBG::LateTick(_float _fTimeDelta)
{
...
HRESULT CToolUITradeBG::AddComponent(vector<string>& _strTextureTags, const string& _strMaskTextureTag, const string& _strNoiseTextureTag, CVIInstancing::InstanceDesc& _InstanceDesc, vector<_float2>& _vUIPos, vector<_float2>& _vUISize)
{
...
shared_ptr<CToolUITradeBG> CToolUITradeBG::Create(vector<string>& _strTextureTags, const string& _strMaskTextureTag, const string& _strNoiseTextureTag, CToolUIBase::ToolUIDesc& _UIDesc, CVIInstancing::InstanceDesc& _InstanceDesc, vector<_float2>& _vUIPos, vector<_float2>& _vUISize)
{
    shared_ptr<CToolUITradeBG> pInstance = make_shared<CToolUITradeBG>();
    ...
    {
        MessageBox(nullptr, L"Initialize Failed", L"CToolUITradeBG::Create", MB_OK);
