...
CToolUICraftHover::CToolUICraftHover()
{
...
HRESULT CToolUICraftHover::Initialize(vector<string>& _strTextureTags, const string& _strMaskTextureTag, const string& _strNoiseTextureTag, CToolUIBase::ToolUIDesc& _UIDesc, CVIInstancing::InstanceDesc& _InstanceDesc, vector<_float2>& _vUIPos, vector<_float2>& _vUISize)
{
...
void CToolUICraftHover::PriorityTick(_float _fTimeDelta)
{

}

void CToolUICraftHover::Tick(_float _fTimeDelta)
{
    KeyInput();
...
void CToolUICraftHover::LateTick(_float _fTimeDelta)
{
...
HRESULT CToolUICraftHover::Render()
{
...
HRESULT CToolUICraftHover::AddComponent(vector<string>& _strTextureTags, const string& _strMaskTextureTag, const string& _strNoiseTextureTag, CVIInstancing::InstanceDesc& _InstanceDesc, vector<_float2>& _vUIPos, vector<_float2>& _vUISize)
{
...
shared_ptr<CToolUICraftHover> CToolUICraftHover::Create(vector<string>& _strTextureTags, const string& _strMaskTextureTag, const string& _strNoiseTextureTag, CToolUIBase::ToolUIDesc& _UIDesc, CVIInstancing::InstanceDesc& _InstanceDesc, vector<_float2>& _vUIPos, vector<_float2>& _vUISize)
{
    shared_ptr<CToolUICraftHover> pInstance = make_shared<CToolUICraftHover>();
    ...
    {
        MessageBox(nullptr, L"Initialize Failed", L"CToolUICraftHover::Create", MB_OK);
