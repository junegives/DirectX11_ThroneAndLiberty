...
HRESULT CToolUICraftBG::Initialize(vector<string>& _strTextureTags, const string& _strMaskTextureTag, const string& _strNoiseTextureTag, CToolUIBase::ToolUIDesc& _UIDesc, CVIInstancing::InstanceDesc& _InstanceDesc, vector<_float2>& _vUIPos, vector<_float2>& _vUISize)
{
...
void CToolUICraftBG::PriorityTick(_float _fTimeDelta)
{

}

void CToolUICraftBG::Tick(_float _fTimeDelta)
{
    KeyInput();
...
void CToolUICraftBG::LateTick(_float _fTimeDelta)
{
...
HRESULT CToolUICraftBG::AddComponent(vector<string>& _strTextureTags, const string& _strMaskTextureTag, const string& _strNoiseTextureTag, CVIInstancing::InstanceDesc& _InstanceDesc, vector<_float2>& _vUIPos, vector<_float2>& _vUISize)
{
...
shared_ptr<CToolUICraftBG> CToolUICraftBG::Create(vector<string>& _strTextureTags, const string& _strMaskTextureTag, const string& _strNoiseTextureTag, CToolUIBase::ToolUIDesc& _UIDesc, CVIInstancing::InstanceDesc& _InstanceDesc, vector<_float2>& _vUIPos, vector<_float2>& _vUISize)
{
    shared_ptr<CToolUICraftBG> pInstance = make_shared<CToolUICraftBG>();
    ...
    {
        MessageBox(nullptr, L"Initialize Failed", L"CToolUICraftBG::Create", MB_OK);
