...
CToolUIOptionBG::CToolUIOptionBG()
{
...
HRESULT CToolUIOptionBG::Initialize(vector<string>& _strTextureTags, const string& _strMaskTextureTag, const string& _strNoiseTextureTag, CToolUIBase::ToolUIDesc& _UIDesc, CVIInstancing::InstanceDesc& _InstanceDesc, vector<_float2>& _vUIPos, vector<_float2>& _vUISize)
{
...
void CToolUIOptionBG::PriorityTick(_float _fTimeDelta)
{

}

void CToolUIOptionBG::Tick(_float _fTimeDelta)
{
    KeyInput();
...
void CToolUIOptionBG::LateTick(_float _fTimeDelta)
{
...
HRESULT CToolUIOptionBG::Render()
{
...
HRESULT CToolUIOptionBG::AddComponent(vector<string>& _strTextureTags, const string& _strMaskTextureTag, const string& _strNoiseTextureTag, CVIInstancing::InstanceDesc& _InstanceDesc, vector<_float2>& _vUIPos, vector<_float2>& _vUISize)
{
...
shared_ptr<CToolUIOptionBG> CToolUIOptionBG::Create(vector<string>& _strTextureTags, const string& _strMaskTextureTag, const string& _strNoiseTextureTag, CToolUIBase::ToolUIDesc& _UIDesc, CVIInstancing::InstanceDesc& _InstanceDesc, vector<_float2>& _vUIPos, vector<_float2>& _vUISize)
{
    shared_ptr<CToolUIOptionBG> pInstance = make_shared<CToolUIOptionBG>();
    ...
    {
        MessageBox(nullptr, L"Initialize Failed", L"CToolUIOptionBG::Create", MB_OK);
