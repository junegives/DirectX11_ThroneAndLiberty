...
CToolUICraftSlot::CToolUICraftSlot()
{
...
HRESULT CToolUICraftSlot::Initialize(vector<string>& _strTextureTags, const string& _strMaskTextureTag, const string& _strNoiseTextureTag, CToolUIBase::ToolUIDesc& _UIDesc, CVIInstancing::InstanceDesc& _InstanceDesc, vector<_float2>& _vUIPos, vector<_float2>& _vUISize)
{
...
void CToolUICraftSlot::PriorityTick(_float _fTimeDelta)
{

}

void CToolUICraftSlot::Tick(_float _fTimeDelta)
{
    KeyInput();
...
void CToolUICraftSlot::LateTick(_float _fTimeDelta)
{
...
HRESULT CToolUICraftSlot::Render()
{
...
HRESULT CToolUICraftSlot::AddComponent(vector<string>& _strTextureTags, const string& _strMaskTextureTag, const string& _strNoiseTextureTag, CVIInstancing::InstanceDesc& _InstanceDesc, vector<_float2>& _vUIPos, vector<_float2>& _vUISize)
{
...
shared_ptr<CToolUICraftSlot> CToolUICraftSlot::Create(vector<string>& _strTextureTags, const string& _strMaskTextureTag, const string& _strNoiseTextureTag, CToolUIBase::ToolUIDesc& _UIDesc, CVIInstancing::InstanceDesc& _InstanceDesc, vector<_float2>& _vUIPos, vector<_float2>& _vUISize)
{
    shared_ptr<CToolUICraftSlot> pInstance = make_shared<CToolUICraftSlot>();
    ...
    {
        MessageBox(nullptr, L"Initialize Failed", L"CToolUICraftSlot::Create", MB_OK);
