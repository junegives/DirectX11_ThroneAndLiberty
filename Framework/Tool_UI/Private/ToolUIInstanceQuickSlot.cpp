...
CToolUIInstanceQuickSlot::CToolUIInstanceQuickSlot()
{
...
HRESULT CToolUIInstanceQuickSlot::Initialize(vector<string>& _strTextureTags, const string& _strMaskTextureTag, const string& _strNoiseTextureTag, CToolUIBase::ToolUIDesc& _UIDesc, CVIInstancing::InstanceDesc& _InstanceDesc, vector<_float2>& _vUIPos, vector<_float2>& _vUISize)
{
...
void CToolUIInstanceQuickSlot::PriorityTick(_float _fTimeDelta)
{

}

void CToolUIInstanceQuickSlot::Tick(_float _fTimeDelta)
{
    KeyInput();
...
void CToolUIInstanceQuickSlot::LateTick(_float _fTimeDelta)
{
...
HRESULT CToolUIInstanceQuickSlot::Render()
{
...
HRESULT CToolUIInstanceQuickSlot::AddComponent(vector<string>& _strTextureTags, const string& _strMaskTextureTag, const string& _strNoiseTextureTag, CVIInstancing::InstanceDesc& _InstanceDesc, vector<_float2>& _vUIPos, vector<_float2>& _vUISize)
{
...
shared_ptr<CToolUIInstanceQuickSlot> CToolUIInstanceQuickSlot::Create(vector<string>& _strTextureTags, const string& _strMaskTextureTag, const string& _strNoiseTextureTag, CToolUIBase::ToolUIDesc& _UIDesc, CVIInstancing::InstanceDesc& _InstanceDesc, vector<_float2>& _vUIPos, vector<_float2>& _vUISize)
{
    shared_ptr<CToolUIInstanceQuickSlot> pInstance = make_shared<CToolUIInstanceQuickSlot>();
    ...
    {
        MessageBox(nullptr, L"Initialize Failed", L"CToolUIInstanceQuickSlot::Create", MB_OK);
