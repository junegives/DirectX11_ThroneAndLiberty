...
CToolUIItemToolTip::CToolUIItemToolTip()
{
...
HRESULT CToolUIItemToolTip::Initialize(vector<string>& _strTextureTags, const string& _strMaskTextureTag, const string& _strNoiseTextureTag, CToolUIBase::ToolUIDesc& _UIDesc, CVIInstancing::InstanceDesc& _InstanceDesc, vector<_float2>& _vUIPos, vector<_float2>& _vUISize)
{
    ...
    m_iShaderPass = 15;
    m_ToolUIDesc.iShaderPassIdx = 15;
...
void CToolUIItemToolTip::PriorityTick(_float _fTimeDelta)
{

}

void CToolUIItemToolTip::Tick(_float _fTimeDelta)
{
    KeyInput();
...
void CToolUIItemToolTip::LateTick(_float _fTimeDelta)
{
...
HRESULT CToolUIItemToolTip::Render()
{
...
HRESULT CToolUIItemToolTip::AddComponent(vector<string>& _strTextureTags, const string& _strMaskTextureTag, const string& _strNoiseTextureTag, CVIInstancing::InstanceDesc& _InstanceDesc, vector<_float2>& _vUIPos, vector<_float2>& _vUISize)
{
...
shared_ptr<CToolUIItemToolTip> CToolUIItemToolTip::Create(vector<string>& _strTextureTags, const string& _strMaskTextureTag, const string& _strNoiseTextureTag, CToolUIBase::ToolUIDesc& _UIDesc, CVIInstancing::InstanceDesc& _InstanceDesc, vector<_float2>& _vUIPos, vector<_float2>& _vUISize)
{
    shared_ptr<CToolUIItemToolTip> pInstance = make_shared<CToolUIItemToolTip>();
    ...
    {
        MessageBox(nullptr, L"Initialize Failed", L"CToolUIItemToolTip::Create", MB_OK);
