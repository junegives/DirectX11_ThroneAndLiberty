...
CToolUITutorial::CToolUITutorial()
{
...
HRESULT CToolUITutorial::Initialize(vector<string>& _strTextureTags, const string& _strMaskTextureTag, const string& _strNoiseTextureTag, CToolUIBase::ToolUIDesc& _UIDesc, CVIInstancing::InstanceDesc& _InstanceDesc, vector<_float2>& _vUIPos, vector<_float2>& _vUISize)
{
...
void CToolUITutorial::PriorityTick(_float _fTimeDelta)
{

}

void CToolUITutorial::Tick(_float _fTimeDelta)
{
    KeyInput();
...
void CToolUITutorial::LateTick(_float _fTimeDelta)
{
...
HRESULT CToolUITutorial::Render()
{
...
HRESULT CToolUITutorial::AddComponent(vector<string>& _strTextureTags, const string& _strMaskTextureTag, const string& _strNoiseTextureTag, CVIInstancing::InstanceDesc& _InstanceDesc, vector<_float2>& _vUIPos, vector<_float2>& _vUISize)
{
...
shared_ptr<CToolUITutorial> CToolUITutorial::Create(vector<string>& _strTextureTags, const string& _strMaskTextureTag, const string& _strNoiseTextureTag, CToolUIBase::ToolUIDesc& _UIDesc, CVIInstancing::InstanceDesc& _InstanceDesc, vector<_float2>& _vUIPos, vector<_float2>& _vUISize)
{
    shared_ptr<CToolUITutorial> pInstance = make_shared<CToolUITutorial>();
    ...
    {
        MessageBox(nullptr, L"Initialize Failed", L"CToolUITutorial::Create", MB_OK);
