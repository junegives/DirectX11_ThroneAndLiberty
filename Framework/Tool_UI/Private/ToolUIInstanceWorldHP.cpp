...
CToolUIInstanceWorldHP::CToolUIInstanceWorldHP()
{
...
HRESULT CToolUIInstanceWorldHP::Initialize(vector<string>& _strTextureTags, const string& _strMaskTextureTag, const string& _strNoiseTextureTag, CToolUIBase::ToolUIDesc& _UIDesc, CVIInstancing::InstanceDesc& _InstanceDesc, vector<_float2>& _vUIPos, vector<_float2>& _vUISize)
{
...
void CToolUIInstanceWorldHP::PriorityTick(_float _fTimeDelta)
{

}

void CToolUIInstanceWorldHP::Tick(_float _fTimeDelta)
{
    KeyInput();
...
void CToolUIInstanceWorldHP::LateTick(_float _fTimeDelta)
{
...
HRESULT CToolUIInstanceWorldHP::Render()
{
...
HRESULT CToolUIInstanceWorldHP::AddComponent(vector<string>& _strTextureTags, const string& _strMaskTextureTag, const string& _strNoiseTextureTag, CVIInstancing::InstanceDesc& _InstanceDesc, vector<_float2>& _vUIPos, vector<_float2>& _vUISize)
{
...
shared_ptr<CToolUIInstanceWorldHP> CToolUIInstanceWorldHP::Create(vector<string>& _strTextureTags, const string& _strMaskTextureTag, const string& _strNoiseTextureTag, CToolUIBase::ToolUIDesc& _UIDesc, CVIInstancing::InstanceDesc& _InstanceDesc, vector<_float2>& _vUIPos, vector<_float2>& _vUISize)
{
    shared_ptr<CToolUIInstanceWorldHP> pInstance = make_shared<CToolUIInstanceWorldHP>();
    ...
    {
        MessageBox(nullptr, L"Initialize Failed", L"CToolUIInstanceWorldHP::Create", MB_OK);
