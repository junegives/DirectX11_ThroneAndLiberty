...
CToolUISpeechBallon::CToolUISpeechBallon()
{
...
HRESULT CToolUISpeechBallon::Initialize(vector<string>& _strTextureTags, const string& _strMaskTextureTag, const string& _strNoiseTextureTag, CToolUIBase::ToolUIDesc& _UIDesc, CVIInstancing::InstanceDesc& _InstanceDesc, vector<_float2>& _vUIPos, vector<_float2>& _vUISize)
{
    ...
    m_iShaderPass = 16;
    m_ToolUIDesc.iShaderPassIdx = 16;
...
void CToolUISpeechBallon::PriorityTick(_float _fTimeDelta)
{

}

void CToolUISpeechBallon::Tick(_float _fTimeDelta)
{
    KeyInput();
...
void CToolUISpeechBallon::LateTick(_float _fTimeDelta)
{
...
HRESULT CToolUISpeechBallon::Render()
{
...
HRESULT CToolUISpeechBallon::AddComponent(vector<string>& _strTextureTags, const string& _strMaskTextureTag, const string& _strNoiseTextureTag, CVIInstancing::InstanceDesc& _InstanceDesc, vector<_float2>& _vUIPos, vector<_float2>& _vUISize)
{
...
shared_ptr<CToolUISpeechBallon> CToolUISpeechBallon::Create(vector<string>& _strTextureTags, const string& _strMaskTextureTag, const string& _strNoiseTextureTag, CToolUIBase::ToolUIDesc& _UIDesc, CVIInstancing::InstanceDesc& _InstanceDesc, vector<_float2>& _vUIPos, vector<_float2>& _vUISize)
{
    shared_ptr<CToolUISpeechBallon> pInstance = make_shared<CToolUISpeechBallon>();
    ...
    {
        MessageBox(nullptr, L"Initialize Failed", L"CToolUISpeechBallon::Create", MB_OK);
