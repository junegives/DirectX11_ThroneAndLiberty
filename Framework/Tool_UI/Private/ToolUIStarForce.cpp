...
CToolUIStarForce::CToolUIStarForce()
{
...
HRESULT CToolUIStarForce::Initialize(vector<string>& _strTextureTags, const string& _strMaskTextureTag, const string& _strNoiseTextureTag, CToolUIBase::ToolUIDesc& _UIDesc, CVIInstancing::InstanceDesc& _InstanceDesc, vector<_float2>& _vUIPos, vector<_float2>& _vUISize)
{
...
void CToolUIStarForce::PriorityTick(_float _fTimeDelta)
{

}

void CToolUIStarForce::Tick(_float _fTimeDelta)
{
    KeyInput();
...
void CToolUIStarForce::LateTick(_float _fTimeDelta)
{
...
HRESULT CToolUIStarForce::Render()
{
...
HRESULT CToolUIStarForce::AddComponent(vector<string>& _strTextureTags, const string& _strMaskTextureTag, const string& _strNoiseTextureTag, CVIInstancing::InstanceDesc& _InstanceDesc, vector<_float2>& _vUIPos, vector<_float2>& _vUISize)
{
...
shared_ptr<CToolUIStarForce> CToolUIStarForce::Create(vector<string>& _strTextureTags, const string& _strMaskTextureTag, const string& _strNoiseTextureTag, CToolUIBase::ToolUIDesc& _UIDesc, CVIInstancing::InstanceDesc& _InstanceDesc, vector<_float2>& _vUIPos, vector<_float2>& _vUISize)
{
    shared_ptr<CToolUIStarForce> pInstance = make_shared<CToolUIStarForce>();
    ...
    {
        MessageBox(nullptr, L"Initialize Failed", L"CToolUIStarForce::Create", MB_OK);
