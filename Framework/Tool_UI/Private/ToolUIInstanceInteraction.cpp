...
CToolUIInstanceInteraction::CToolUIInstanceInteraction()
{
...
HRESULT CToolUIInstanceInteraction::Initialize(vector<string>& _strTextureTags, const string& _strMaskTextureTag, const string& _strNoiseTextureTag, CToolUIBase::ToolUIDesc& _UIDesc, CVIInstancing::InstanceDesc& _InstanceDesc, vector<_float2>& _vUIPos, vector<_float2>& _vUISize)
{
...
void CToolUIInstanceInteraction::PriorityTick(_float _fTimeDelta)
{

}

void CToolUIInstanceInteraction::Tick(_float _fTimeDelta)
{
    KeyInput();
...
void CToolUIInstanceInteraction::LateTick(_float _fTimeDelta)
{
...
HRESULT CToolUIInstanceInteraction::Render()
{
...
HRESULT CToolUIInstanceInteraction::AddComponent(vector<string>& _strTextureTags, const string& _strMaskTextureTag, const string& _strNoiseTextureTag, CVIInstancing::InstanceDesc& _InstanceDesc, vector<_float2>& _vUIPos, vector<_float2>& _vUISize)
{
...
shared_ptr<CToolUIInstanceInteraction> CToolUIInstanceInteraction::Create(vector<string>& _strTextureTags, const string& _strMaskTextureTag, const string& _strNoiseTextureTag, CToolUIBase::ToolUIDesc& _UIDesc, CVIInstancing::InstanceDesc& _InstanceDesc, vector<_float2>& _vUIPos, vector<_float2>& _vUISize)
{
    shared_ptr<CToolUIInstanceInteraction> pInstance = make_shared<CToolUIInstanceInteraction>();
    ...
    {
        MessageBox(nullptr, L"Initialize Failed", L"CToolUIInstanceInteraction::Create", MB_OK);
