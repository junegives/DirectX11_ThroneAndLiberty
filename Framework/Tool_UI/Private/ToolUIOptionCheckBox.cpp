...
CToolUIOptionCheckBox::CToolUIOptionCheckBox()
{
...
HRESULT CToolUIOptionCheckBox::Initialize(vector<string>& _strTextureTags, const string& _strMaskTextureTag, const string& _strNoiseTextureTag, CToolUIBase::ToolUIDesc& _UIDesc, CVIInstancing::InstanceDesc& _InstanceDesc, vector<_float2>& _vUIPos, vector<_float2>& _vUISize)
{
    ...
    m_iShaderPass = 18;
    m_ToolUIDesc.iShaderPassIdx = 18;
...
void CToolUIOptionCheckBox::PriorityTick(_float _fTimeDelta)
{

}

void CToolUIOptionCheckBox::Tick(_float _fTimeDelta)
{
    KeyInput();
...
void CToolUIOptionCheckBox::LateTick(_float _fTimeDelta)
{
...
HRESULT CToolUIOptionCheckBox::Render()
{
...
HRESULT CToolUIOptionCheckBox::AddComponent(vector<string>& _strTextureTags, const string& _strMaskTextureTag, const string& _strNoiseTextureTag, CVIInstancing::InstanceDesc& _InstanceDesc, vector<_float2>& _vUIPos, vector<_float2>& _vUISize)
{
...
shared_ptr<CToolUIOptionCheckBox> CToolUIOptionCheckBox::Create(vector<string>& _strTextureTags, const string& _strMaskTextureTag, const string& _strNoiseTextureTag, CToolUIBase::ToolUIDesc& _UIDesc, CVIInstancing::InstanceDesc& _InstanceDesc, vector<_float2>& _vUIPos, vector<_float2>& _vUISize)
{
    shared_ptr<CToolUIOptionCheckBox> pInstance = make_shared<CToolUIOptionCheckBox>();
    ...
    {
        MessageBox(nullptr, L"Initialize Failed", L"CToolUIOptionCheckBox::Create", MB_OK);
