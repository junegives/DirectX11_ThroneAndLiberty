...
CToolUIQuestComplete::CToolUIQuestComplete()
{
...
HRESULT CToolUIQuestComplete::Initialize(vector<string>& _strTextureTags, const string& _strMaskTextureTag, const string& _strNoiseTextureTag, CToolUIBase::ToolUIDesc& _UIDesc, CVIInstancing::InstanceDesc& _InstanceDesc, vector<_float2>& _vUIPos, vector<_float2>& _vUISize)
{
    ...
    m_iShaderPass = 14;
    m_ToolUIDesc.iShaderPassIdx = 14;
...
void CToolUIQuestComplete::PriorityTick(_float _fTimeDelta)
{

}

void CToolUIQuestComplete::Tick(_float _fTimeDelta)
{
    KeyInput();
...
void CToolUIQuestComplete::LateTick(_float _fTimeDelta)
{
...
HRESULT CToolUIQuestComplete::Render()
{
...
HRESULT CToolUIQuestComplete::AddComponent(vector<string>& _strTextureTags, const string& _strMaskTextureTag, const string& _strNoiseTextureTag, CVIInstancing::InstanceDesc& _InstanceDesc, vector<_float2>& _vUIPos, vector<_float2>& _vUISize)
{
...
shared_ptr<CToolUIQuestComplete> CToolUIQuestComplete::Create(vector<string>& _strTextureTags, const string& _strMaskTextureTag, const string& _strNoiseTextureTag, CToolUIBase::ToolUIDesc& _UIDesc, CVIInstancing::InstanceDesc& _InstanceDesc, vector<_float2>& _vUIPos, vector<_float2>& _vUISize)
{
    shared_ptr<CToolUIQuestComplete> pInstance = make_shared<CToolUIQuestComplete>();
    ...
    {
        MessageBox(nullptr, L"Initialize Failed", L"CToolUIQuestComplete::Create", MB_OK);
