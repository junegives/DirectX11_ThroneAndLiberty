...
CToolUIInstanceQuickBG::CToolUIInstanceQuickBG()
{
}
...
HRESULT CToolUIInstanceQuickBG::Initialize(vector<string>& _strTextureTags, const string& _strMaskTextureTag, const string& _strNoiseTextureTag, CToolUIBase::ToolUIDesc& _UIDesc, CVIInstancing::InstanceDesc& _InstanceDesc, vector<_float2>& _vUIPos, vector<_float2>& _vUISize)
{
    ...
    if (m_ToolUIDesc.m_eUIType == TOOL_UI_INSTANCEQUICKFRAME)
    {
        m_iShaderPass = 5;
...
void CToolUIInstanceQuickBG::PriorityTick(_float _fTimeDelta)
{

}

void CToolUIInstanceQuickBG::Tick(_float _fTimeDelta)
{
    KeyInput();
...
void CToolUIInstanceQuickBG::LateTick(_float _fTimeDelta)
{
...
HRESULT CToolUIInstanceQuickBG::Render()
{
...
HRESULT CToolUIInstanceQuickBG::AddComponent(vector<string>& _strTextureTags, const string& _strMaskTextureTag, const string& _strNoiseTextureTag, CVIInstancing::InstanceDesc& _InstanceDesc, vector<_float2>& _vUIPos, vector<_float2>& _vUISize)
{
...
shared_ptr<CToolUIInstanceQuickBG> CToolUIInstanceQuickBG::Create(vector<string>& _strTextureTags, const string& _strMaskTextureTag, const string& _strNoiseTextureTag, CToolUIBase::ToolUIDesc& _UIDesc, CVIInstancing::InstanceDesc& _InstanceDesc, vector<_float2>& _vUIPos, vector<_float2>& _vUISize)
{
    shared_ptr<CToolUIInstanceQuickBG> pInstance = make_shared<CToolUIInstanceQuickBG>();
    ...
    {
        MessageBox(nullptr, L"Initialize Failed", L"CToolUIInstanceQuickBG::Create", MB_OK);
