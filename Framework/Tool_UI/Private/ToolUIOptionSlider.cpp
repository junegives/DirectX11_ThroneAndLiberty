...
CToolUIOptionSlider::CToolUIOptionSlider()
{
...
HRESULT CToolUIOptionSlider::Initialize(vector<string>& _strTextureTags, const string& _strMaskTextureTag, const string& _strNoiseTextureTag, CToolUIBase::ToolUIDesc& _UIDesc, CVIInstancing::InstanceDesc& _InstanceDesc, vector<_float2>& _vUIPos, vector<_float2>& _vUISize)
{
...
void CToolUIOptionSlider::PriorityTick(_float _fTimeDelta)
{

}

void CToolUIOptionSlider::Tick(_float _fTimeDelta)
{
    KeyInput();
...
void CToolUIOptionSlider::LateTick(_float _fTimeDelta)
{
...
HRESULT CToolUIOptionSlider::Render()
{
...
HRESULT CToolUIOptionSlider::AddComponent(vector<string>& _strTextureTags, const string& _strMaskTextureTag, const string& _strNoiseTextureTag, CVIInstancing::InstanceDesc& _InstanceDesc, vector<_float2>& _vUIPos, vector<_float2>& _vUISize)
{
...
shared_ptr<CToolUIOptionSlider> CToolUIOptionSlider::Create(vector<string>& _strTextureTags, const string& _strMaskTextureTag, const string& _strNoiseTextureTag, CToolUIBase::ToolUIDesc& _UIDesc, CVIInstancing::InstanceDesc& _InstanceDesc, vector<_float2>& _vUIPos, vector<_float2>& _vUISize)
{
    shared_ptr<CToolUIOptionSlider> pInstance = make_shared<CToolUIOptionSlider>();
    ...
    {
        MessageBox(nullptr, L"Initialize Failed", L"CToolUIOptionSlider::Create", MB_OK);
