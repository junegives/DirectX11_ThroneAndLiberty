...
CToolUIInstanceBossHP::CToolUIInstanceBossHP()
{
...
HRESULT CToolUIInstanceBossHP::Initialize(vector<string>& _strTextureTags, const string& _strMaskTextureTag, const string& _strNoiseTextureTag, CToolUIBase::ToolUIDesc& _UIDesc, CVIInstancing::InstanceDesc& _InstanceDesc, vector<_float2>& _vUIPos, vector<_float2>& _vUISize)
{
...
void CToolUIInstanceBossHP::PriorityTick(_float _fTimeDelta)
{
}

void CToolUIInstanceBossHP::Tick(_float _fTimeDelta)
{
    KeyInput();
...
void CToolUIInstanceBossHP::LateTick(_float _fTimeDelta)
{
...
HRESULT CToolUIInstanceBossHP::Render()
{
...
HRESULT CToolUIInstanceBossHP::AddComponent(vector<string>& _strTextureTags, const string& _strMaskTextureTag, const string& _strNoiseTextureTag, CVIInstancing::InstanceDesc& _InstanceDesc, vector<_float2>& _vUIPos, vector<_float2>& _vUISize)
{
...
shared_ptr<CToolUIInstanceBossHP> CToolUIInstanceBossHP::Create(vector<string>& _strTextureTags, const string& _strMaskTextureTag, const string& _strNoiseTextureTag, CToolUIBase::ToolUIDesc& _UIDesc, CVIInstancing::InstanceDesc& _InstanceDesc, vector<_float2>& _vUIPos, vector<_float2>& _vUISize)
{
    shared_ptr<CToolUIInstanceBossHP> pInstance = make_shared<CToolUIInstanceBossHP>();
    ...
    {
        MessageBox(nullptr, L"Initialize Failed", L"CToolUIInstanceBossHP::Create", MB_OK);
