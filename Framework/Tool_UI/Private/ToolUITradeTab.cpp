...
CToolUITradeTab::CToolUITradeTab()
{
...
HRESULT CToolUITradeTab::Initialize(vector<string>& _strTextureTags, const string& _strMaskTextureTag, const string& _strNoiseTextureTag, CToolUIBase::ToolUIDesc& _UIDesc, CVIInstancing::InstanceDesc& _InstanceDesc, vector<_float2>& _vUIPos, vector<_float2>& _vUISize)
{
...
void CToolUITradeTab::PriorityTick(_float _fTimeDelta)
{

}

void CToolUITradeTab::Tick(_float _fTimeDelta)
{
    KeyInput();
...
void CToolUITradeTab::LateTick(_float _fTimeDelta)
{
...
HRESULT CToolUITradeTab::Render()
{
...
HRESULT CToolUITradeTab::AddComponent(vector<string>& _strTextureTags, const string& _strMaskTextureTag, const string& _strNoiseTextureTag, CVIInstancing::InstanceDesc& _InstanceDesc, vector<_float2>& _vUIPos, vector<_float2>& _vUISize)
{
...
shared_ptr<CToolUITradeTab> CToolUITradeTab::Create(vector<string>& _strTextureTags, const string& _strMaskTextureTag, const string& _strNoiseTextureTag, CToolUIBase::ToolUIDesc& _UIDesc, CVIInstancing::InstanceDesc& _InstanceDesc, vector<_float2>& _vUIPos, vector<_float2>& _vUISize)
{
    shared_ptr<CToolUITradeTab> pInstance = make_shared<CToolUITradeTab>();
    ...
    {
        MessageBox(nullptr, L"Initialize Failed", L"CToolUITradeTab::Create", MB_OK);
