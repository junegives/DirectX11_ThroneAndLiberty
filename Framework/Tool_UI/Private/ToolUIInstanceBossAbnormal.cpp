...
CToolUIInstanceBossAbnormal::CToolUIInstanceBossAbnormal()
{
...
HRESULT CToolUIInstanceBossAbnormal::Initialize(vector<string>& _strTextureTags, const string& _strMaskTextureTag, const string& _strNoiseTextureTag, CToolUIBase::ToolUIDesc& _UIDesc, CVIInstancing::InstanceDesc& _InstanceDesc, vector<_float2>& _vUIPos, vector<_float2>& _vUISize)
{
...
void CToolUIInstanceBossAbnormal::PriorityTick(_float _fTimeDelta)
{

}

void CToolUIInstanceBossAbnormal::Tick(_float _fTimeDelta)
{
    KeyInput();
...
void CToolUIInstanceBossAbnormal::LateTick(_float _fTimeDelta)
{
...
HRESULT CToolUIInstanceBossAbnormal::Render()
{
...
HRESULT CToolUIInstanceBossAbnormal::AddComponent(vector<string>& _strTextureTags, const string& _strMaskTextureTag, const string& _strNoiseTextureTag, CVIInstancing::InstanceDesc& _InstanceDesc, vector<_float2>& _vUIPos, vector<_float2>& _vUISize)
{
...
shared_ptr<CToolUIInstanceBossAbnormal> CToolUIInstanceBossAbnormal::Create(vector<string>& _strTextureTags, const string& _strMaskTextureTag, const string& _strNoiseTextureTag, CToolUIBase::ToolUIDesc& _UIDesc, CVIInstancing::InstanceDesc& _InstanceDesc, vector<_float2>& _vUIPos, vector<_float2>& _vUISize)
{
    shared_ptr<CToolUIInstanceBossAbnormal> pInstance = make_shared<CToolUIInstanceBossAbnormal>();
    ...
    {
        MessageBox(nullptr, L"Initialize Failed", L"CToolUIInstanceBossAbnormal::Create", MB_OK);
