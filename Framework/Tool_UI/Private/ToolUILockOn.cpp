...
HRESULT CToolUILockOn::Initialize(vector<string>& _strTextureTags, const string& _strMaskTextureTag, const string& _strNoiseTextureTag, CToolUIBase::ToolUIDesc& _ToolUIDesc, CVIInstancing::InstanceDesc& _InstanceDesc)
{
...
void CToolUILockOn::PriorityTick(_float _fDeltaTime)
{

}

void CToolUILockOn::Tick(_float _fDeltaTime)
{
    KeyInput();
...
void CToolUILockOn::LateTick(_float _fDeltaTime)
{
...
HRESULT CToolUILockOn::AddComponent(vector<string>& _strTextureTags, const string& _strMaskTextureTag, const string& _strNoiseTextureTag, CVIInstancing::InstanceDesc& _InstanceDesc)
{
...
shared_ptr<CToolUILockOn> CToolUILockOn::Create(vector<string>& _strTextureTags, const string& _strMaskTextureTag, const string& _strNoiseTextureTag, CToolUIBase::ToolUIDesc& _ToolUIDesc, CVIInstancing::InstanceDesc& _InstanceDesc)
{
    shared_ptr<CToolUILockOn> pInstance = make_shared<CToolUILockOn>();

    if (FAILED(pInstance->Initialize(_strTextureTags, _strMaskTextureTag, _strNoiseTextureTag, _ToolUIDesc, _InstanceDesc)))
    {
        MessageBox(nullptr, L"Initialize Failed", L"CToolUILockOn::Create", MB_OK);
