...
CToolUIInstanceCraftTab::CToolUIInstanceCraftTab()
{
...
HRESULT CToolUIInstanceCraftTab::Initialize(vector<string>& _strTextureTags, const string& _strMaskTextureTag, const string& _strNoiseTextureTag, CToolUIBase::ToolUIDesc& _UIDesc, CVIInstancing::InstanceDesc& _InstanceDesc, vector<_float2>& _vUIPos, vector<_float2>& _vUISize)
{
...
void CToolUIInstanceCraftTab::PriorityTick(_float _fTimeDelta)
{

}

void CToolUIInstanceCraftTab::Tick(_float _fTimeDelta)
{
    KeyInput();
...
void CToolUIInstanceCraftTab::LateTick(_float _fTimeDelta)
{
...
HRESULT CToolUIInstanceCraftTab::Render()
{
...
HRESULT CToolUIInstanceCraftTab::AddComponent(vector<string>& _strTextureTags, const string& _strMaskTextureTag, const string& _strNoiseTextureTag, CVIInstancing::InstanceDesc& _InstanceDesc, vector<_float2>& _vUIPos, vector<_float2>& _vUISize)
{
...
shared_ptr<CToolUIInstanceCraftTab> CToolUIInstanceCraftTab::Create(vector<string>& _strTextureTags, const string& _strMaskTextureTag, const string& _strNoiseTextureTag, CToolUIBase::ToolUIDesc& _UIDesc, CVIInstancing::InstanceDesc& _InstanceDesc, vector<_float2>& _vUIPos, vector<_float2>& _vUISize)
{
    shared_ptr<CToolUIInstanceCraftTab> pInstance = make_shared<CToolUIInstanceCraftTab>();
    ...
    {
        MessageBox(nullptr, L"Initialize Failed", L"CToolUIInstanceCraftTab::Create", MB_OK);
