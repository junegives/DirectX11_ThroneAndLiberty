...
CToolUIInstanceQuest::CToolUIInstanceQuest()
{
...
HRESULT CToolUIInstanceQuest::Initialize(vector<string>& _strTextureTags, const string& _strMaskTextureTag, const string& _strNoiseTextureTag, CToolUIBase::ToolUIDesc& _UIDesc, CVIInstancing::InstanceDesc& _InstanceDesc, vector<_float2>& _vUIPos, vector<_float2>& _vUISize, shared_ptr<CCustomFont> _pCustomFont)
{
    ...
    m_iShaderPass = 10;
    m_ToolUIDesc.iShaderPassIdx = 10;
...
void CToolUIInstanceQuest::PriorityTick(_float _fTimeDelta)
{

}

void CToolUIInstanceQuest::Tick(_float _fTimeDelta)
{
    KeyInput();
...
void CToolUIInstanceQuest::LateTick(_float _fTimeDelta)
{
...
HRESULT CToolUIInstanceQuest::Render()
{
...
HRESULT CToolUIInstanceQuest::AddComponent(vector<string>& _strTextureTags, const string& _strMaskTextureTag, const string& _strNoiseTextureTag, CVIInstancing::InstanceDesc& _InstanceDesc, vector<_float2>& _vUIPos, vector<_float2>& _vUISize)
{
...
shared_ptr<CToolUIInstanceQuest> CToolUIInstanceQuest::Create(vector<string>& _strTextureTags, const string& _strMaskTextureTag, const string& _strNoiseTextureTag, CToolUIBase::ToolUIDesc& _UIDesc, CVIInstancing::InstanceDesc& _InstanceDesc, vector<_float2>& _vUIPos, vector<_float2>& _vUISize, shared_ptr<CCustomFont> _pCustomFont)
{
    shared_ptr<CToolUIInstanceQuest> pInstance = make_shared<CToolUIInstanceQuest>();

    if (FAILED(pInstance->Initialize(_strTextureTags, _strMaskTextureTag, _strNoiseTextureTag, _UIDesc, _InstanceDesc, _vUIPos, _vUISize, _pCustomFont)))
    {
        MessageBox(nullptr, L"Initialize Failed", L"CToolUIInstanceQuest::Create", MB_OK);
