...
CToolUIOptionHover::CToolUIOptionHover()
{
...
HRESULT CToolUIOptionHover::Initialize(vector<string>& _strTextureTags, const string& _strMaskTextureTag, const string& _strNoiseTextureTag, CToolUIBase::ToolUIDesc& _UIDesc, CVIInstancing::InstanceDesc& _InstanceDesc, vector<_float2>& _vUIPos, vector<_float2>& _vUISize)
{
...
void CToolUIOptionHover::PriorityTick(_float _fTimeDelta)
{

}

void CToolUIOptionHover::Tick(_float _fTimeDelta)
{
    KeyInput();
...
void CToolUIOptionHover::LateTick(_float _fTimeDelta)
{
...
HRESULT CToolUIOptionHover::Render()
{
...
HRESULT CToolUIOptionHover::AddComponent(vector<string>& _strTextureTags, const string& _strMaskTextureTag, const string& _strNoiseTextureTag, CVIInstancing::InstanceDesc& _InstanceDesc, vector<_float2>& _vUIPos, vector<_float2>& _vUISize)
{
...
shared_ptr<CToolUIOptionHover> CToolUIOptionHover::Create(vector<string>& _strTextureTags, const string& _strMaskTextureTag, const string& _strNoiseTextureTag, CToolUIBase::ToolUIDesc& _UIDesc, CVIInstancing::InstanceDesc& _InstanceDesc, vector<_float2>& _vUIPos, vector<_float2>& _vUISize)
{
    shared_ptr<CToolUIOptionHover> pInstance = make_shared<CToolUIOptionHover>();
    ...
    {
        MessageBox(nullptr, L"Initialize Failed", L"CToolUIOptionHover::Create", MB_OK);
