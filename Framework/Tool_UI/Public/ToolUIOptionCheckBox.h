...
class CToolUIOptionCheckBox : public CToolUIBase
{
	using Super = CToolUIBase;

public:
	CToolUIOptionCheckBox();
	virtual ~CToolUIOptionCheckBox();
...
public:
	static shared_ptr<CToolUIOptionCheckBox> Create(vector<string>& _strTextureTags, const string& _strMaskTextureTag, const string& _strNoiseTextureTag, CToolUIBase::ToolUIDesc& _UIDesc, CVIInstancing::InstanceDesc& _InstanceDesc, vector<_float2>& _vUIPos, vector<_float2>& _vUISize);
