...
class CToolUICover : public CToolUIBase
{
	using Super = CToolUIBase;

public:
	CToolUICover();
	virtual ~CToolUICover();
...
public:
	static shared_ptr<CToolUICover> Create(vector<string>& _strTextureTags, const string& _strMaskTextureTag, const string& _strNoiseTextureTag, CToolUIBase::ToolUIDesc& _ToolUIDesc, CVIInstancing::InstanceDesc& _InstanceDesc, _float2 _initPos = _float2(0.f, 0.f));
