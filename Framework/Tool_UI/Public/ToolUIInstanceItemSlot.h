...
class CToolUIInstanceItemSlot : public CToolUIBase
{
	using Super = CToolUIBase;

public:
	CToolUIInstanceItemSlot();
	virtual ~CToolUIInstanceItemSlot();
...
public:
	static shared_ptr<CToolUIInstanceItemSlot> Create(vector<string>& _strTextureTags, const string& _strMaskTextureTag, const string& _strNoiseTextureTag, CToolUIBase::ToolUIDesc& _UIDesc, CVIInstancing::InstanceDesc& _InstanceDesc, vector<_float2>& _vUIPos, vector<_float2>& _vUISize);
