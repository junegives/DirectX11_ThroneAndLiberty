...
class CToolUIItemBackGround : public CToolUIBase
{
	using Super = CToolUIBase;

public:
	CToolUIItemBackGround();
	virtual ~CToolUIItemBackGround();
...
public:
	static shared_ptr<CToolUIItemBackGround> Create(vector<string>& _strTextureTags, const string& _strMaskTextureTag, const string& _strNoiseTextureTag, CToolUIBase::ToolUIDesc& _ToolUIDesc, CVIInstancing::InstanceDesc& _InstanceDesc, _float2 _initPos = _float2(0.f, 0.f));
