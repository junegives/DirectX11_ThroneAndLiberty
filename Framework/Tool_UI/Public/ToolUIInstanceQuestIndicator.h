...
class CToolUIInstanceQuestIndicator : public CToolUIBase
{
	using Super = CToolUIBase;

public:
	CToolUIInstanceQuestIndicator();
	virtual ~CToolUIInstanceQuestIndicator();
...
public:
	static shared_ptr<CToolUIInstanceQuestIndicator> Create(vector<string>& _strTextureTags, const string& _strMaskTextureTag, const string& _strNoiseTextureTag, CToolUIBase::ToolUIDesc& _UIDesc, CVIInstancing::InstanceDesc& _InstanceDesc, vector<_float2>& _vUIPos, vector<_float2>& _vUISize);
