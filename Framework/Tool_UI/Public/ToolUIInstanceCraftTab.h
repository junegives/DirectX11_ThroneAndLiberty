...
class CToolUIInstanceCraftTab : public CToolUIBase
{
	using Super = CToolUIBase;

public:
	CToolUIInstanceCraftTab();
	virtual ~CToolUIInstanceCraftTab();
...
public:
	static shared_ptr<CToolUIInstanceCraftTab> Create(vector<string>& _strTextureTags, const string& _strMaskTextureTag, const string& _strNoiseTextureTag, CToolUIBase::ToolUIDesc& _UIDesc, CVIInstancing::InstanceDesc& _InstanceDesc, vector<_float2>& _vUIPos, vector<_float2>& _vUISize);
