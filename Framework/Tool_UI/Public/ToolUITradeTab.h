...
class CToolUITradeTab : public CToolUIBase
{
	using Super = CToolUIBase;

public:
	CToolUITradeTab();
	virtual ~CToolUITradeTab();
...
public:
	static shared_ptr<CToolUITradeTab> Create(vector<string>& _strTextureTags, const string& _strMaskTextureTag, const string& _strNoiseTextureTag, CToolUIBase::ToolUIDesc& _UIDesc, CVIInstancing::InstanceDesc& _InstanceDesc, vector<_float2>& _vUIPos, vector<_float2>& _vUISize);
