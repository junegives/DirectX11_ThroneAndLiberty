...
class CToolUIInstanceItemBG : public CToolUIBase
{
	using Super = CToolUIBase;

public:
	CToolUIInstanceItemBG();
	virtual ~CToolUIInstanceItemBG();
...
public:
	//static shared_ptr<CToolUIInstanceItemBG> Create(vector<string>& _strTextureTags, const string& _strMaskTextureTag, const string& _strNoiseTextureTag, CToolUIBase::ToolUIDesc& _UIDesc, InstanceUI& _InstanceDesc, vector<_float2>& _vUIPos, vector<_float2>& _vUISize);
	static shared_ptr<CToolUIInstanceItemBG> Create(vector<string>& _strTextureTags, const string& _strMaskTextureTag, const string& _strNoiseTextureTag, CToolUIBase::ToolUIDesc& _UIDesc, CVIInstancing::InstanceDesc& _InstanceDesc, vector<_float2>& _vUIPos, vector<_float2>& _vUISize);
