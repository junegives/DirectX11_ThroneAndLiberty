...
class CToolUIQuestComplete : public CToolUIBase
{
	using Super = CToolUIBase;

public:
	CToolUIQuestComplete();
	virtual ~CToolUIQuestComplete();
...
public:
	static shared_ptr<CToolUIQuestComplete> Create(vector<string>& _strTextureTags, const string& _strMaskTextureTag, const string& _strNoiseTextureTag, CToolUIBase::ToolUIDesc& _UIDesc, CVIInstancing::InstanceDesc& _InstanceDesc, vector<_float2>& _vUIPos, vector<_float2>& _vUISize);
