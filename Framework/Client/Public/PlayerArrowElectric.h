...
class CPlayerArrowElectric : public CPlayerProjectile
{
public:
	CPlayerArrowElectric();
	virtual ~CPlayerArrowElectric()  override;
...
public:
	static shared_ptr<CPlayerArrowElectric> Create();
