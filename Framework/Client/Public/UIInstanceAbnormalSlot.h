...
class CUIInstanceAbnormalSlot : public CUIBase
{
	using Super = CUIBase;

public:
	CUIInstanceAbnormalSlot();
	virtual ~CUIInstanceAbnormalSlot();
...
public:
	static shared_ptr<CUIInstanceAbnormalSlot> Create(vector<string>& _strTextureTags, const string& _strMaskTextureTag, const string& _strNoiseTextureTag, CUIBase::UIDesc& _UIDesc, CVIInstancing::InstanceDesc& _InstanceDesc, vector<_float2>& _vUIPos, vector<_float2>& _vUISize);
