...
class CUICraftHover : public CUIBase
{
	using Super = CUIBase;

public:
	CUICraftHover();
	virtual ~CUICraftHover();
...
public:
	static shared_ptr<CUICraftHover> Create(vector<string>& _strTextureTags, const string& _strMaskTextureTag, const string& _strNoiseTextureTag, CUIBase::UIDesc& _UIDesc, CVIInstancing::InstanceDesc& _InstanceDesc, vector<_float2>& _vUIPos, vector<_float2>& _vUISize);
