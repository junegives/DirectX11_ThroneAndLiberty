...
class CUILockOn : public CUIBase
{
	using Super = CUIBase;
...
public:
	static shared_ptr<CUILockOn> Create(vector<string>& _strTextureTags, const string& _strMaskTextureTag, const string& _strNoiseTextureTag, CUIBase::UIDesc& _UIDesc, CVIInstancing::InstanceDesc& _InstanceDesc);
