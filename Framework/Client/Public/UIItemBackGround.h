...
class CUIItemBackGround : public CUIBase
{
	using Super = CUIBase;

public:
	CUIItemBackGround();
	virtual ~CUIItemBackGround();
...
public:
	static shared_ptr<CUIItemBackGround> Create(vector<string>& _strTextureTags, const string& _strMaskTextureTag, const string& _strNoiseTextureTag, CUIBase::UIDesc& _UIDesc, CVIInstancing::InstanceDesc& _InstanceDesc, _float2 _initPos = _float2(0.f, 0.f));
