...
class CPlayerSpellMeteor : public CPlayerProjectile
{
public:
	CPlayerSpellMeteor();
	virtual ~CPlayerSpellMeteor()  override;
...
private:
	_float	m_fDropTime		= { 0.33f };
	_bool	m_isCrash		= { false };
	_float	m_fLifeTime		= { 0.2f };

public:
	static shared_ptr<CPlayerSpellMeteor> Create();
