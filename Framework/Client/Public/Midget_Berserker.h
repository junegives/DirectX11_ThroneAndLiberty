...
// 특정 액션 상태
enum MI_B_ActionState
{
	MI_B_A_BLOCKED = 0,
	MI_B_A_COMBATSTART = 5,
	MI_B_A_DEAD = 6,
	MI_B_A_DEATH = 7,
	MI_B_A_DOWN3 = 10,
	MI_B_A_DOWN2 = 11,
	...
	MI_B_A_SEARCH = 25,
	MI_B_A_SHOCKED = 26,
	MI_B_A_ATTACK1_A = 29,		// 일반공격
	MI_B_A_ATTACK1_B = 30,
	MI_B_A_ATTACK1_C = 31,
	MI_B_A_ATTACK2_A = 32,		// 내려찍기2
	MI_B_A_ATTACK2_B = 33,
	MI_B_A_ATTACK3_A = 35,		// 회전공격1
	MI_B_A_ATTACK3_B = 36,
	MI_B_A_ATTACK4_A = 37,		// 회전공격2
	MI_B_A_ATTACK4_B = 38,
	MI_B_A_ATTACK5_A = 39,		// 내려찍기1
	MI_B_A_ATTACK5_B = 40,
	MI_B_A_ATTACK5_C = 41,
	MI_B_A_JUMPATTACK1_C = 42,
	MI_B_A_JUMPATTACK1_B = 43,
	MI_B_A_JUMPATTACK1_A = 44,	// 점프공격1
	MI_B_A_JUMPATTACK2_C = 45,
	MI_B_A_JUMPATTACK2_B = 46,
	MI_B_A_JUMPATTACK2_A = 47,	// 점프공격2
	MI_B_A_APPEAR = 48,			// 뛰어나오기
	MI_B_A_DANCE1 = 49,		
	MI_B_A_DANCE2 = 50,
	MI_B_A_DANCE3 = 51,
	MI_B_A_STDALT = 57,			// 전투자세
	MI_B_A_STDALT1 = 58,
	MI_B_A_STDALT2 = 59,
	MI_B_A_STDIDLE = 60,
	MI_B_A_STUNE = 61,
...
class CMidget_Berserker final : public CMonster
{
public:
...
public:
	CMidget_Berserker();
	virtual ~CMidget_Berserker()  override;
...
public:
	static shared_ptr<CMidget_Berserker> Create(_float3 _vCreatePos);
...
private:
	...
	_int		m_iBaseState = MI_B_B_BEFOREMEET;			// Base상태
	_int		m_iDistanceState = MI_B_D_BEFOREMEET;		// 거리에 따른 상태
	_int		m_iActionState = MI_B_A_STDIDLE;			// 행동상태
	_int		m_iSkillState = MI_B_S_NOSKILL;				// 스킬상태
	...
	_float		m_fMemoryOutTime = m_fKeyFrameSpeed * 38.f;

	_float		m_fSpin1SoundStartTime = m_fKeyFrameSpeed * 10.f;
	_float		m_fSpin1SoundEndTime = m_fKeyFrameSpeed * 78.f;
	_float		m_fSpin2SoundStartTime = m_fKeyFrameSpeed * 10.f;
	_float		m_fSpin2SoundEndTime = m_fKeyFrameSpeed * 146.f;

	_bool		m_bWhirlWindSoundStart = false;
	_bool		m_bWhirlWindSoundEnd = false;
