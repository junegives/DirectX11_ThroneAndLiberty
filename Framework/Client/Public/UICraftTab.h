...
class CUICraftTab : public CUIBase
{
	using Super = CUIBase;
...
public:
	void SetCurTabIndex(_uint _iIndex) { m_iCurTabIndex = _iIndex; }
	_uint GetCurTabIndex() { return m_iCurTabIndex; }
...
public:
	static shared_ptr<CUICraftTab> Create(vector<string>& _strTextureTags, const string& _strMaskTextureTag, const string& _strNoiseTextureTag, CUIBase::UIDesc& _UIDesc, CVIInstancing::InstanceDesc& _InstanceDesc, vector<_float2>& _vUIPos, vector<_float2>& _vUISize);
