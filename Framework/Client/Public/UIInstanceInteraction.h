...
class CUIInstanceInteraction : public CUIBase
{
	using Super = CUIBase;

public:
	CUIInstanceInteraction();
	virtual ~CUIInstanceInteraction();
...
public:
	static shared_ptr<CUIInstanceInteraction> Create(vector<string>& _strTextureTags, const string& _strMaskTextureTag, const string& _strNoiseTextureTag, CUIBase::UIDesc& _UIDesc, CVIInstancing::InstanceDesc& _InstanceDesc, vector<_float2>& _vUIPos, vector<_float2>& _vUISize);
