...
// Skill 상태
enum OC_DC_SkillState
{
	OC_DC_S_SKILL1 = 0,	// 패턴1
	OC_DC_S_SKILL2,		// 패턴2
	OC_DC_S_SKILL3,		// 패턴3
	OC_DC_S_SKILL4,		// 패턴4
	OC_DC_S_NOSKILL		// x
...
// Base 상태
enum OC_DC_BaseState
{
	OC_DC_B_BEFOREMEET = 0,
	OC_DC_B_GENERATE,
	OC_DC_B_NORMAL,
	OC_DC_B_BLOCKED,
	OC_DC_B_HITTED,
...
enum OC_DC_ActionState
{
	...
	OC_DC_A_FURY = 26,
	OC_DC_A_SPECIAL = 27,
	OC_DC_A_ATTACK1_A = 28,		// 오른쪽으로
	OC_DC_A_ATTACK1_A2 = 29,	// 오른쪽으로
	OC_DC_A_ATTACK1_B = 30,		// 왼쪽으로
	OC_DC_A_ATTACK1_B2 = 31,	// 왼쪽으로
	OC_DC_A_ATTACK1_C = 32,		// 오른쪽중단으로
	OC_DC_A_ATTACK1_C2 = 33,	// 오른쪽중단으로
	OC_DC_A_ATTACK2_A1 = 34,	// 3연격 시작
	OC_DC_A_ATTACK2_A2 = 35,
	OC_DC_A_ATTACK2_A3 = 36,
	OC_DC_A_ATTACK2_A4 = 37,
	OC_DC_A_ATTACK2_A5 = 38,
	OC_DC_A_ATTACK2_A6 = 39,
	OC_DC_A_ATTACK2_B1 = 40,	// 2연격 시작
	OC_DC_A_ATTACK2_B2 = 41,
	OC_DC_A_ATTACK2_B3 = 42,
	OC_DC_A_ATTACK2_B4 = 43,
	OC_DC_A_ATTACK2_C1 = 44,	// 돌기 공격
	OC_DC_A_ATTACK2_C2 = 45,
	OC_DC_A_ATTACK3_A1 = 46,	// 특수 연격
	OC_DC_A_ATTACK3_A2 = 47,
	OC_DC_A_ATTACK3_A3 = 48,
	OC_DC_A_ATTACK3_A4 = 49,
	OC_DC_A_ATTACK3_A5 = 50,
	OC_DC_A_ATTACK3_A6 = 51,
	OC_DC_A_ATTACK3_A7 = 52,
	OC_DC_A_ATTACK4 = 53,		// 직선장판강타공격
	OC_DC_A_DASH3 = 55,
	OC_DC_A_DASH2 = 56,
	OC_DC_A_DASH1 = 57,
	OC_DC_A_SKTRFA1 = 58,
...
class COrc_DarkCommander final : public CMonster
{
public:
...
public:
	COrc_DarkCommander();
	virtual ~COrc_DarkCommander()  override;
...
public:
	static shared_ptr<COrc_DarkCommander> Create(_float3 _vCreatePos);
	void CameraStart() { m_bCameraStart = true; }
...
/* For.Trail */
private:
	shared_ptr<class CWeapon> m_pWeapon;
...
private:
	shared_ptr<CMemory>		m_pMemory;		// 기억
	_bool		m_bMemoryOut = false;
	
	_int		m_iBaseState = OC_DC_B_BEFOREMEET;			// Base상태
	_int		m_iDistanceState = OC_DC_D_BEFOREMEET;		// 거리에 따른 상태
	_int		m_iActionState = OC_DC_A_STDIDLE;			// 행동상태
	_int		m_iSkillState = OC_DC_S_NOSKILL;			// 스킬상태
	...
	// 키프레임 시간 관련
	_float		m_fMemoryOutTime = m_fKeyFrameSpeed * 80.f;
