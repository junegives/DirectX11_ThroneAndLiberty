...
HRESULT CUICraftTab::Initialize(vector<string>& _strTextureTags, const string& _strMaskTextureTag, const string& _strNoiseTextureTag, CUIBase::UIDesc& _UIDesc, CVIInstancing::InstanceDesc& _InstanceDesc, vector<_float2>& _vUIPos, vector<_float2>& _vUISize)
{
...
void CUICraftTab::PriorityTick(_float _fTimeDelta)
{

}

void CUICraftTab::Tick(_float _fTimeDelta)
{
    KeyInput();
...
void CUICraftTab::LateTick(_float _fTimeDelta)
{
...
void CUICraftTab::InitUpdateTexture()
{
...
void CUICraftTab::UpdateTexture()
{
    D3D11_MAPPED_SUBRESOURCE subResource{};
...
HRESULT CUICraftTab::AddComponent(vector<string>& _strTextureTags, const string& _strMaskTextureTag, const string& _strNoiseTextureTag, CVIInstancing::InstanceDesc& _InstanceDesc, vector<_float2>& _vUIPos, vector<_float2>& _vUISize)
{
...
shared_ptr<CUICraftTab> CUICraftTab::Create(vector<string>& _strTextureTags, const string& _strMaskTextureTag, const string& _strNoiseTextureTag, CUIBase::UIDesc& _UIDesc, CVIInstancing::InstanceDesc& _InstanceDesc, vector<_float2>& _vUIPos, vector<_float2>& _vUISize)
{
    shared_ptr<CUICraftTab> pInstance = make_shared<CUICraftTab>();
    ...
    {
        MessageBox(nullptr, L"Initialize Failed", L"CUICraftTab::Create", MB_OK);
