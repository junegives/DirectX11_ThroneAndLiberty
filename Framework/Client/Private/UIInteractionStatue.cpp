...
CUIInteractionStatue::CUIInteractionStatue()
{
...
HRESULT CUIInteractionStatue::Initialize(vector<string>& _strTextureTags, const string& _strMaskTextureTag, const string& _strNoiseTextureTag, CUIBase::UIDesc& _UIDesc, CVIInstancing::InstanceDesc& _InstanceDesc)
{
...
void CUIInteractionStatue::PriorityTick(_float _fDeltaTime)
{

}

void CUIInteractionStatue::Tick(_float _fDeltaTime)
{
    if (!m_isLoadingDone)
        return;
...
void CUIInteractionStatue::LateTick(_float _fDeltaTime)
{
    if (!m_isLoadingDone)
        return;
...
HRESULT CUIInteractionStatue::Render()
{
...
HRESULT CUIInteractionStatue::RenderFont()
{

	return S_OK;
}

HRESULT CUIInteractionStatue::AddComponent(vector<string>& _strTextureTags, const string& _strMaskTextureTag, const string& _strNoiseTextureTag, CVIInstancing::InstanceDesc& _InstanceDesc)
{
...
shared_ptr<CUIInteractionStatue> CUIInteractionStatue::Create(vector<string>& _strTextureTags, const string& _strMaskTextureTag, const string& _strNoiseTextureTag, CUIBase::UIDesc& _UIDesc, CVIInstancing::InstanceDesc& _InstanceDesc)
{
    shared_ptr<CUIInteractionStatue> pInstance = make_shared<CUIInteractionStatue>();
