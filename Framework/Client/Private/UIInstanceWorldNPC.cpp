...
CUIInstanceWorldNPC::CUIInstanceWorldNPC()
{
...
HRESULT CUIInstanceWorldNPC::Initialize(vector<string>& _strTextureTags, const string& _strMaskTextureTag, const string& _strNoiseTextureTag, CUIBase::UIDesc& _UIDesc, CVIInstancing::InstanceDesc& _InstanceDesc, vector<_float2>& _vUIPos, vector<_float2>& _vUISize)
{
...
void CUIInstanceWorldNPC::PriorityTick(_float _fTimeDelta)
{
...
void CUIInstanceWorldNPC::Tick(_float _fTimeDelta)
{
...
void CUIInstanceWorldNPC::LateTick(_float _fTimeDelta)
{
...
HRESULT CUIInstanceWorldNPC::Render()
{
...
void CUIInstanceWorldNPC::UpdateTexture()
{
    D3D11_MAPPED_SUBRESOURCE subResource{};
...
HRESULT CUIInstanceWorldNPC::AddComponent(vector<string>& _strTextureTags, const string& _strMaskTextureTag, const string& _strNoiseTextureTag, CVIInstancing::InstanceDesc& _InstanceDesc, vector<_float2>& _vUIPos, vector<_float2>& _vUISize)
{
...
shared_ptr<CUIInstanceWorldNPC> CUIInstanceWorldNPC::Create(vector<string>& _strTextureTags, const string& _strMaskTextureTag, const string& _strNoiseTextureTag, CUIBase::UIDesc& _UIDesc, CVIInstancing::InstanceDesc& _InstanceDesc, vector<_float2>& _vUIPos, vector<_float2>& _vUISize)
{
    shared_ptr<CUIInstanceWorldNPC> pInstance = make_shared<CUIInstanceWorldNPC>();
    ...
    {
        MessageBox(nullptr, L"Initialize Failed", L"CUIInstanceWorldNPC::Create", MB_OK);
