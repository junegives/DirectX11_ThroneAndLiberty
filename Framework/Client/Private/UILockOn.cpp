...
HRESULT CUILockOn::Initialize(vector<string>& _strTextureTags, const string& _strMaskTextureTag, const string& _strNoiseTextureTag, CUIBase::UIDesc& _UIDesc, CVIInstancing::InstanceDesc& _InstanceDesc)
{
...
void CUILockOn::PriorityTick(_float _fDeltaTime)
{
}

void CUILockOn::Tick(_float _fDeltaTime)
{
    KeyInput();
...
void CUILockOn::LateTick(_float _fDeltaTime)
{
...
HRESULT CUILockOn::AddComponent(vector<string>& _strTextureTags, const string& _strMaskTextureTag, const string& _strNoiseTextureTag, CVIInstancing::InstanceDesc& _InstanceDesc)
{
...
shared_ptr<CUILockOn> CUILockOn::Create(vector<string>& _strTextureTags, const string& _strMaskTextureTag, const string& _strNoiseTextureTag, CUIBase::UIDesc& _UIDesc, CVIInstancing::InstanceDesc& _InstanceDesc)
{
    shared_ptr<CUILockOn> pInstance = make_shared<CUILockOn>();

    if (FAILED(pInstance->Initialize(_strTextureTags, _strMaskTextureTag, _strNoiseTextureTag, _UIDesc, _InstanceDesc)))
    {
        MessageBox(nullptr, L"Initialize Failed", L"CUILockOn::Create", MB_OK);
