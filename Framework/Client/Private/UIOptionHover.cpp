...
HRESULT CUIOptionHover::Initialize(vector<string>& _strTextureTags, const string& _strMaskTextureTag, const string& _strNoiseTextureTag, CUIBase::UIDesc& _UIDesc, CVIInstancing::InstanceDesc& _InstanceDesc, vector<_float2>& _vUIPos, vector<_float2>& _vUISize)
{
...
void CUIOptionHover::PriorityTick(_float _fTimeDelta)
{

}

void CUIOptionHover::Tick(_float _fTimeDelta)
{
    if (m_isLoadingDone)
    {
        KeyInput();
...
void CUIOptionHover::LateTick(_float _fTimeDelta)
{
    if (m_isLoadingDone)
    {
...
HRESULT CUIOptionHover::RenderFont()
{

    return S_OK;
}

void CUIOptionHover::OptionKeyInput()
{
...
void CUIOptionHover::InitUpdateTexture()
{
...
void CUIOptionHover::UpdateTexture()
{
    D3D11_MAPPED_SUBRESOURCE subResource{};
...
HRESULT CUIOptionHover::AddComponent(vector<string>& _strTextureTags, const string& _strMaskTextureTag, const string& _strNoiseTextureTag, CVIInstancing::InstanceDesc& _InstanceDesc, vector<_float2>& _vUIPos, vector<_float2>& _vUISize)
{
...
shared_ptr<CUIOptionHover> CUIOptionHover::Create(vector<string>& _strTextureTags, const string& _strMaskTextureTag, const string& _strNoiseTextureTag, CUIBase::UIDesc& _UIDesc, CVIInstancing::InstanceDesc& _InstanceDesc, vector<_float2>& _vUIPos, vector<_float2>& _vUISize)
{
    shared_ptr<CUIOptionHover> pInstance = make_shared<CUIOptionHover>();
    ...
    {
        MessageBox(nullptr, L"Initialize Failed", L"CUIOptionHover::Create", MB_OK);
