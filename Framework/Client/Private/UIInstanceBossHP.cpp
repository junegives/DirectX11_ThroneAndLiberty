...
CUIInstanceBossHP::CUIInstanceBossHP()
{
...
HRESULT CUIInstanceBossHP::Initialize(vector<string>& _strTextureTags, const string& _strMaskTextureTag, const string& _strNoiseTextureTag, CUIBase::UIDesc& _UIDesc, CVIInstancing::InstanceDesc& _InstanceDesc, vector<_float2>& _vUIPos, vector<_float2>& _vUISize)
{
...
void CUIInstanceBossHP::PriorityTick(_float _fTimeDelta)
{

}

void CUIInstanceBossHP::Tick(_float _fTimeDelta)
{
    KeyInput();
...
void CUIInstanceBossHP::LateTick(_float _fTimeDelta)
{
...
HRESULT CUIInstanceBossHP::Render()
{
...
void CUIInstanceBossHP::UpdateTexture()
{
    D3D11_MAPPED_SUBRESOURCE subResource{};
    ...
    vertices[2].vUVRatio = _float2(m_fRatio, 0.f);
    vertices[2].iSlotUV = 1;

    switch (m_iBossIconType)
    {
    case 0:
    {
...
HRESULT CUIInstanceBossHP::AddComponent(vector<string>& _strTextureTags, const string& _strMaskTextureTag, const string& _strNoiseTextureTag, CVIInstancing::InstanceDesc& _InstanceDesc, vector<_float2>& _vUIPos, vector<_float2>& _vUISize)
{
...
shared_ptr<CUIInstanceBossHP> CUIInstanceBossHP::Create(vector<string>& _strTextureTags, const string& _strMaskTextureTag, const string& _strNoiseTextureTag, CUIBase::UIDesc& _UIDesc, CVIInstancing::InstanceDesc& _InstanceDesc, vector<_float2>& _vUIPos, vector<_float2>& _vUISize)
{
    shared_ptr<CUIInstanceBossHP> pInstance = make_shared<CUIInstanceBossHP>();
    ...
    {
        MessageBox(nullptr, L"Initialize Failed", L"CUIInstanceBossHP::Create", MB_OK);
