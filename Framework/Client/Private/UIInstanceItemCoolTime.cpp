...
CUIInstanceItemCoolTime::CUIInstanceItemCoolTime()
{
...
HRESULT CUIInstanceItemCoolTime::Initialize(vector<string>& _strTextureTags, const string& _strMaskTextureTag, const string& _strNoiseTextureTag, CUIBase::UIDesc& _UIDesc, CVIInstancing::InstanceDesc& _InstanceDesc, vector<_float2>& _vUIPos, vector<_float2>& _vUISize)
{
...
void CUIInstanceItemCoolTime::PriorityTick(_float _fTimeDelta)
{

}

void CUIInstanceItemCoolTime::Tick(_float _fTimeDelta)
{
    KeyInput();
...
void CUIInstanceItemCoolTime::LateTick(_float _fTimeDelta)
{
...
HRESULT CUIInstanceItemCoolTime::Render()
{
...
void CUIInstanceItemCoolTime::IsRender(_float _fVisibleYTop, _float _fVisibleYBottom)
{
    /* CoolTime은 아마 안쓸 예정 */
...
HRESULT CUIInstanceItemCoolTime::AddComponent(vector<string>& _strTextureTags, const string& _strMaskTextureTag, const string& _strNoiseTextureTag, CVIInstancing::InstanceDesc& _InstanceDesc, vector<_float2>& _vUIPos, vector<_float2>& _vUISize)
{
...
shared_ptr<CUIInstanceItemCoolTime> CUIInstanceItemCoolTime::Create(vector<string>& _strTextureTags, const string& _strMaskTextureTag, const string& _strNoiseTextureTag, CUIBase::UIDesc& _UIDesc, CVIInstancing::InstanceDesc& _InstanceDesc, vector<_float2>& _vUIPos, vector<_float2>& _vUISize)
{
    shared_ptr<CUIInstanceItemCoolTime> pInstance = make_shared<CUIInstanceItemCoolTime>();
    ...
    {
        MessageBox(nullptr, L"Initialize Failed", L"CUIInstanceItemCoolTime::Create", MB_OK);
