...
HRESULT CUICrossHair::Initialize(vector<string>& _strTextureTags, const string& _strMaskTextureTag, const string& _strNoiseTextureTag, CUIBase::UIDesc& _UIDesc, CVIInstancing::InstanceDesc& _InstanceDesc)
{
...
void CUICrossHair::PriorityTick(_float _fDeltaTime)
{

}

void CUICrossHair::Tick(_float _fDeltaTime)
{
    KeyInput();
...
void CUICrossHair::LateTick(_float _fDeltaTime)
{
...
HRESULT CUICrossHair::AddComponent(vector<string>& _strTextureTags, const string& _strMaskTextureTag, const string& _strNoiseTextureTag, CVIInstancing::InstanceDesc& _InstanceDesc)
{
...
shared_ptr<CUICrossHair> CUICrossHair::Create(vector<string>& _strTextureTags, const string& _strMaskTextureTag, const string& _strNoiseTextureTag, CUIBase::UIDesc& _UIDesc, CVIInstancing::InstanceDesc& _InstanceDesc)
{
    shared_ptr<CUICrossHair> pInstance = make_shared<CUICrossHair>();

    if (FAILED(pInstance->Initialize(_strTextureTags, _strMaskTextureTag, _strNoiseTextureTag, _UIDesc, _InstanceDesc)))
    {
        MessageBox(nullptr, L"Initialize Failed", L"CUICrossHair::Create", MB_OK);
